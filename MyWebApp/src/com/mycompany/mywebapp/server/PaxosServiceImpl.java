...
public class PaxosServiceImpl extends RemoteServiceServlet implements PaxosService{
    ...
    private void outwardsPreprocess(PaxosReq req) throws IllegalArgumentException{
        ...
        HashMap<Integer,Deque<PaxosAckReq>> targetDataStructure;

        if (req instanceof PaxosPrepareReq) {
            targetDataStructure =(HashMap<Integer,Deque<PaxosReq>>) prepareMessagePoolMap;
        }
        if (req instanceof PaxosAckReq){
            targetDataStructure = ackMessagePoolmap;
        }
        if(req instanceof PaxosAcceptReq){
            targetDataStructure = acceptMessagePoolMap;
        }
        if(req instanceof PaxosEnquireReq){
            targetDataStructure = enquireMessagePoolMap;
        }

        if(!targetDataStructure.containsKey(req.target)){
            throw new IllegalArgumentException("Target has not registered yet...");
        }
        if(!targetDataStructure.containsKey(req.source)){
    ...
    private void inwardsPreprocessing(Integer source){
    ...
    public PaxosAckReq pollAck(Integer source) throws IllegalArgumentException {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'pollAck'");
    }

    @Override
    public PaxosAcceptReq pollAccept(Integer source) throws IllegalArgumentException {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'pollAccept'");
    }

    @Override
    public PaxosEnquireReq pollEnquire(Integer source) throws IllegalArgumentException {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'pollEnquire'");
    }
